...
<div class="block block-rounded block-bordered invisible" data-toggle="appear">
    <div class="block-header block-header-default sticky-top">
        ...
        <div class="block-options">
            ...
            <a href="{{route("panel.structure.edit",[$formEntry->form->structure->id,"model_id"=>$formEntry->form->id])}}"
    ...
    <div class="block-content">
        {!! \Orbitali\Foundations\Helpers\Structure::renderStructure($formEntry->form->structure->data) !!}
    </div>
</div>
{{ html()->form()->close() }}
@endsection