                            ...
                            <div class="col-md-12 bg-white">
                                <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                    ...
                                    <div class="mb-2 text-center">
                                        ...
                                        <p class="text-uppercase font-w700 font-size-sm text-muted">@lang(['native.auth.passwords.email.title','Password Reminder'])</p>
                                    </div>
                                    ...
                                    <form class="js-validation-signin" action="{{ route('password.email') }}"
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-block btn-hero-primary">
                                                <i class="fa fa-fw fa-reply mr-1"></i> @lang(['native.auth.passwords.email.send_password_reset_link','Send Password Reset Link'])
                                            </button>
