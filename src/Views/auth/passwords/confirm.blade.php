                            ...
                            <div class="col-md-12 bg-white">
                                <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                    ...
                                    <div class="mb-2 text-center">
                                        ...
                                        <p class="text-uppercase font-w700 font-size-sm text-muted">@lang(['native.auth.confirm.title','Confirm Password'])</p>
                                    </div>
                                    {{-- Confirm Form --}}
                                    <form class="js-validation-signin" action="{{ route('password.confirm') }}"
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-block btn-hero-primary">
                                                <i class="fa fa-fw fa-fw fa-sign-in-alt mr-1"></i> @lang(['native.auth.confirm.submit','Confirm Password'])
                                            </button>
