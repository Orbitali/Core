...
class FontAwesomeIcons implements IDatasource
{
    public function source()
    {
        return [
            ...
            "fa-7x" => "Size: 7x",
            "fa-10x" => "Size: 10x",
            "fa-fw" => "Helper: Fixed Width",
            "fa-spin" => "Helper: Animate",
            "fa-border" => "Helper: Border",
            "fa-rotate-90" => "Rotate: 90°",
            "fa-rotate-180" => "Rotate: 180°",
            "fa-rotate-270" => "Rotate: 270°",
            "fa-flip-horizontal" => "Helper: mirrors icon horizontally",
            "fa-flip-vertical" => "Helper: mirrors icon vertically",
            "fa-flip-both" =>
                "Helper: mirrors icon vertically and horizontally",
            "fab fa-500px" => "500px",
