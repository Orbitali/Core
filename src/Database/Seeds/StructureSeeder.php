    ...
    public function run()
    {
        DB::table("structures")->insert([
            ...
            [
                ...
                "mode" => "menus",
                "data" =>
                    "[{\"name\"=>\"status\",\"=>show-on-list-empty-header\"=>true,\"=>show-on-list-order\"=>0,\"title\"=>\"Status\",\"=>rules\"=>[\"required\"],\"=>show-on-list\"=>true,\"=>tag\"=>\"Status\",\"=>show-on-list-prefix\"=>\"\"},{\"name\"=>\"website\",\"type\"=>\"select\",\"title\"=>\"Websites\",\"=>rules\"=>[\"required\"],\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\Websites\",\"=>tag\"=>\"FormGroup\",\"=>multiple\"=>false},{\"name\"=>\"type\",\"type\"=>\"select\",\"title\"=>\"Type\",\"=>rules\"=>[\"required\"],\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\MenuTypes\",\"=>tag\"=>\"FormGroup\",\"=>multiple\"=>false},{\"title\"=>\"Detail Panel\",\"=>tag\"=>\"DetailPanel\",\"=>children\"=>[{\"name\"=>\"name\",\"=>show-on-list-empty-header\"=>true,\"type\"=>\"text\",\"=>show-on-list-order\"=>2,\"title\"=>\"Name\",\"=>rules\"=>[\"required\"],\"=>show-on-list\"=>true,\"=>tag\"=>\"FormGroup\",\"=>show-on-list-prefix\"=>\"detail.\"}]},{\"name\"=>\"data\",\"type\"=>\"select\",\"title\"=>\"Route\",\"=>rules\"=>[],\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\RouteList\",\"=>tag\"=>\"FormGroup\",\"=>multiple\"=>false},{\"name\"=>\"data\",\"type\"=>\"select\",\"title\"=>\"Data Source\",\"=>rules\"=>[],\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\Datasources\",\"=>tag\"=>\"FormGroup\",\"=>multiple\"=>false},{\"name\"=>\"data\",\"type\"=>\"select\",\"title\"=>\"Internal\",\"=>rules\"=>[],\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\InternalUrls\",\"=>tag\"=>\"FormGroup\",\"=>multiple\"=>false},{\"=>auto-height\"=>true,\"type\"=>\"textarea\",\"name\"=>\"data\",\"=>rules\"=>[],\"title\"=>\"Javascript\",\"=>tag\"=>\"FormGroup\"},{\"type\"=>\"url\",\"name\"=>\"data\",\"=>rules\"=>[\"required_unless=>type,root\"],\"title\"=>\"Url\",\"=>tag\"=>\"FormGroup\"},{\"title\"=>\"Script\",\"=>tag\"=>\"Script\",\"=>content\"=>\"var types = [\\\"route\\\", \\\"datasource\\\", \\\"internal\\\", \\\"javascript\\\", \\\"external\\\"];\\n$(\\\"[name=type]\\\")\\n  .on(\\\"change\\\", function () {\\n    var select = this;\\n    $(\\\".form-group=>has([name=data])\\\").map(function (index, element) {\\n      if (types[index] == select.value) {\\n        $(\\\"input,textarea,select\\\", $(element).show()).prop(\\\"disabled\\\", false);\\n      } else {\\n        $(\\\"input,textarea,select\\\", $(element).hide()).prop(\\\"disabled\\\", true);\\n      }\\n    });\\n  })\\n  .change();\"}]",
            ],
            [
            ...
            [
                ...
                "mode" => "self",
                "data" =>
                    "[{\"name\"=>\"status\",\"=>rules\"=>[\"required\"],\"=>show-on-list-prefix\"=>\"\",\"title\"=>\"Status\",\"=>show-on-list-empty-header\"=>true,\"=>show-on-list\"=>true,\"=>tag\"=>\"Status\",\"=>show-on-list-order\"=>0},{\"name\"=>\"icon\",\"=>rules\"=>[],\"=>multiple\"=>true,\"title\"=>\"Icon\",\"=>prevent-sort\"=>true,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\FontAwesomeIcons\",\"type\"=>\"select\",\"=>tag\"=>\"FormGroup\"},{\"name\"=>\"website\",\"=>rules\"=>[\"required\"],\"=>multiple\"=>false,\"title\"=>\"Websites\",\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\Websites\",\"type\"=>\"select\",\"=>tag\"=>\"FormGroup\"},{\"name\"=>\"type\",\"=>rules\"=>[\"required\"],\"=>multiple\"=>false,\"title\"=>\"Type\",\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\MenuTypes\",\"type\"=>\"select\",\"=>tag\"=>\"FormGroup\"},{\"=>tag\"=>\"DetailPanel\",\"=>children\"=>[{\"name\"=>\"name\",\"=>show-on-list-order\"=>2,\"=>rules\"=>[\"required\"],\"=>show-on-list-prefix\"=>\"detail.\",\"title\"=>\"Name\",\"=>show-on-list-empty-header\"=>true,\"=>show-on-list\"=>true,\"=>tag\"=>\"FormGroup\",\"type\"=>\"text\"}],\"title\"=>\"Detail Panel\"},{\"name\"=>\"data\",\"=>rules\"=>[],\"=>multiple\"=>false,\"title\"=>\"Route\",\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\RouteList\",\"type\"=>\"select\",\"=>tag\"=>\"FormGroup\"},{\"name\"=>\"data\",\"=>rules\"=>[],\"=>multiple\"=>false,\"title\"=>\"Data Source\",\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\Datasources\",\"type\"=>\"select\",\"=>tag\"=>\"FormGroup\"},{\"name\"=>\"data\",\"=>rules\"=>[],\"=>multiple\"=>false,\"title\"=>\"Internal\",\"=>prevent-sort\"=>false,\"=>data-source\"=>\"Orbitali\\\\Foundations\\\\Datasources\\\\InternalUrls\",\"type\"=>\"select\",\"=>tag\"=>\"FormGroup\"},{\"=>rules\"=>[],\"=>auto-height\"=>true,\"type\"=>\"textarea\",\"name\"=>\"data\",\"=>tag\"=>\"FormGroup\",\"title\"=>\"Javascript\"},{\"=>rules\"=>[\"required_unless=>type,root\"],\"type\"=>\"url\",\"name\"=>\"data\",\"=>tag\"=>\"FormGroup\",\"title\"=>\"Url\"},{\"=>tag\"=>\"Script\",\"=>content\"=>\"var types = [\\\"route\\\", \\\"datasource\\\", \\\"internal\\\", \\\"javascript\\\", \\\"external\\\"];\\n$(\\\"[name=type]\\\")\\n  .on(\\\"change\\\", function () {\\n    var select = this;\\n    $(\\\".form-group=>has([name=data])\\\").map(function (index, element) {\\n      if (types[index] == select.value) {\\n        $(\\\"input,textarea,select\\\", $(element).show()).prop(\\\"disabled\\\", false);\\n      } else {\\n        $(\\\"input,textarea,select\\\", $(element).hide()).prop(\\\"disabled\\\", true);\\n      }\\n    });\\n  })\\n  .change();\",\"title\"=>\"Script\"}]",
            ],
        ]);
    }
}
