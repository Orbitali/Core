    ...
    public function run()
    {
        DB::table("structures")->insert([
            ...
            [
                ...
                "mode" => "users",
                "data" =>
                    '[{":tag":"Status",":rules":["required"],"title":"Status"},{":tag":"FormGroup","type":"text","title":"Name","name":"name",":rules":["required","string"]},{":tag":"FormGroup","type":"text","title":"Email","name":"email",":rules":["required","email","unique:users,email,@id"]},{":tag":"FormGroup","type":"select",":multiple":false,":prevent-sort":false,"title":"Preferred Language","name":"language",":rules":[],":data-source":"\\\\Orbitali\\\\Foundations\\\\Datasources\\\\Languages"},{":tag":"FormGroup","type":"select",":multiple":true,":prevent-sort":false,"title":"Roles","name":"roles",":rules":[],":data-source":"\\\\Orbitali\\\\Foundations\\\\Datasources\\\\Roles"}]',
            ],
            [
                "model_type" => "nodes",
                "model_id" => 0,
