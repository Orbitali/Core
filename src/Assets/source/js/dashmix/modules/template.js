...
*/
    ...
    _uiApiBlocks(mode = 'init', block = false) {
        ...
        let iconFullscreen         = 'fa fa-expand-arrows-alt';
        let iconFullscreenActive   = 'fa fa-compress-arrows-alt';
        let iconContent            = 'fa fa-chevron-up';
        let iconContentActive      = 'fa fa-chevron-down';
        ...
        if (mode === 'init') {
            ...
            if (elBlock.length) {
                ...
                btnFullscreen       = jQuery('>.block-header [data-toggle="block-option"][data-action="fullscreen_toggle"]', elBlock);
                btnContentToggle    = jQuery('>.block-header [data-toggle="block-option"][data-action="content_toggle"]', elBlock);
